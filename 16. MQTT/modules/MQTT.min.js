...
0,retain:d&1},a.qos&&this.client.write(f((1==a.qos?e.PUBACK:e.PUBREC)<<4)+"\x02"+a.pid),this.emit("publish",a),this.emit("message",a.topic,a.message)):c===e.PUBACK?this.emit("puback",a.charCodeAt(2)<<8|a.charCodeAt(3)):c===e.PUBREC?this.client.write(f(e.PUBREL<<4|2)+"\x02"+b.substr(0,2)):c===e.PUBREL?this.client.write(f(e.PUBCOMP<<4)+"\x02"+b.substr(0,2)):c===e.PUBCOMP?this.emit("pubcomp",a.charCodeAt(2)<<8|a.charCodeAt(3)):c===e.SUBACK?0<b.length&&(128==b[b.length-1]?this.emit("subscribed_fail"):
